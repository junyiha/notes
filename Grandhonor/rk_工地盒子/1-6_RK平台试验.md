...
# 第三次 增加自启动脚本
docker run -it -d --privileged=true -v /userdata/:/userdata/ -v /dev/media0:/dev/media0/ -v /dev/galcore:/dev/galcore -v /usr/:/rk_usr/ --device=/dev/galcore  -p 8000:8000 -p 8001:8001 -p 10022:10022 -p 10008:10008 -p 10009:10009 -p 10010:10010 -p 10011:10011 -p 10012:10012 -p 10013:10013 -p 17008:17008 ubuntu/20.04:0621 /bin/bash /etc/init.d/auto-mnc.sh
```
