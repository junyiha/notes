...
public:
    static void set_exit_flag(int flag);

    static int get_exit_flag();
};
...
void Base::set_exit_flag(int flag)
{
    flag_set(FLAG_KEY_EXIT, flag);
}

int Base::get_exit_flag()
{
    int exit_flag = 0;
    exit_flag = flag_get(FLAG_KEY_EXIT);
